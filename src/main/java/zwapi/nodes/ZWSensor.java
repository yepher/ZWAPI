 ...
 * <p>
 * Sensors can set associations, nodes to which basic set commands are sendwhen motion is detected. Sensors can also have configuration parameters which can be
 * set (parameters are adressed by ID, and is specific to the fabricator's implementation.
 * </p>
 * <p>
 * Sensors recieve events when a configuration or association report is recieved, and when the network controller recieves a basic set from the sensor.
 * </p>
 * 
...
public class ZWSensor extends ZWNode {
    ...
    public void setConfigurationParameter(byte param, byte value) throws NoAssociatedNetworkException {
        ...
        this.network.sendData(this.id, cmd);
    }
     ...
     * 
     * @param group
     *            The group containing the z-wave sensor
     * @throws NoAssociatedNetworkException
     */
     ...
     *            The target
     * @param group
     *            The group containing the nodes
     * @throws NoAssociatedNetworkException
     */
    ...
    public void addZWConfigurationListener(ZWConfigurationListener listener) {
        this.listeners.add(ZWConfigurationListener.class, listener);
    }
    ...
    public void removeZWConfigurationListener(ZWConfigurationListener listener) {
        this.listeners.remove(ZWConfigurationListener.class, listener);
    }
    ...
    public void addZWAssociationListener(ZWAssociationListener listener) {
        this.listeners.add(ZWAssociationListener.class, listener);
    }
    ...
    public void removeZWAssociationListener(ZWAssociationListener listener) {
        this.listeners.remove(ZWAssociationListener.class, listener);
    }
